...
public class HuiyuanUpdate extends JFrame{
...
////	-----按钮方法-----
	private void btn_saveActionPerformed(ActionEvent e) {
		Huiyuan cus=new Huiyuan();
		cus.setKehuNum(tf_kehuNum.getText());
		cus.setKehuName(tf_kehuName.getText());
		cus.setPhone(tf_phone.getText());
		cus.setDizhi(tf_dizhi.getText());
		...
		int i = HuiyuanDao.updateCusAndid(cus);
		if(i == 1){
